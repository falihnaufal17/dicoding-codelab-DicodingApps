...
class AcademiesViewController: UIViewController {
    ...
    @objc func objectTapped(gesture: UIGestureRecognizer){
        // Digunakan untuk inisialisasi DetailViewController
        guard let controller = UIStoryboard(
                name: "Main",
                bundle: nil
        ).instantiateViewController(withIdentifier: "DetailViewControllerScene") as? DetailViewController else { return }
